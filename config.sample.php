<?php
/**
 * config.sample.php — TEMPLATE. Copy to config.php on the server and fill in real values.
 * config.php itself is git-ignored so credentials never reach GitHub.
 *
 * (Original header follows.) config.php — the ONLY file you need to edit when deploying.
 *
...
define('DB_NAME', 'u123456789_logbook');    // <-- replace with your hPanel database name
define('DB_USER', 'u123456789_dbuser');     // <-- replace with your hPanel database username
define('DB_PASS', 'CHANGE_ME'); // <-- replace with your hPanel database password
 ...
 */
define('SSO_SHARED_SECRET', 'CHANGE_ME_64_HEX_CHARS_SAME_AS_SALES_REPORTER');
