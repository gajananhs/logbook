...
define('SMTP_USER', 'noreply@canaresonline.com');   // <-- the sending mailbox, from hPanel > Emails
define('SMTP_PASS', 'Quickfix@2026');            // <-- that mailbox's password, from hPanel > Emails
